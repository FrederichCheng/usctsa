                ...
                <table class="housing" border="2" cellpadding="" cellspacing="">
                    <tr>
                        <td class="housing_pic" align="left" valign="top">
                            <A href="#" onclick="window.open('housePicDetail.html','', 'scrollbar=yes,width=700px, height=600px')" target="_blank"><img src="assets/images/house_pic1.jpg" alt="House image" width="160" height="150">
                            </A>
                        </td>
