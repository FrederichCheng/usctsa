...
$housing_sections = array(
	...
	'sections' => array( 'add_extra' => FALSE, 'init_display' => 'none', 'dblclick' => 'accordian', 'repeatable' => TRUE, 'style' => 'width: 950px;', 'type' => 'template', 'label' => 'Page sections', 'title_field' => 'title',
        'fields' => array(
                'sections' => array('type' => 'section', 'label' => '{__title__}'),
                'title' => array('label' => 'Title', 'required'=> true), 
                'house_img' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image First'),
                'location' => array('label' => 'Location'),
                ...
                'price' => array('label' => 'Price'),
                'description' => array('type' => 'textarea','label' => 'Description'),
                'sImg1' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image Big'),
                'sImg2' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg3' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg4' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg5' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg6' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg7' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
                'sImg8' => array('type' => 'asset', 'style' => 'width: 200px; height: 200px;', 'label' => 'House Image'),
